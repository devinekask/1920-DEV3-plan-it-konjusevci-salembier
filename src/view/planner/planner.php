...
<ul class="steps">
<li class="step"><a class="step__link" href="">1</a></li>
...
<label>Cardio
<input id="cardio" type="checkbox" class="checkbox__button"></label>
<label>Bench
<input id="bench" type="checkbox" class="checkbox__button"></label>
<label>swole
<input id="swole" type="checkbox" class="checkbox__button"></label>
<label>bulking
<input id="bulking" type="checkbox" class="checkbox__button"></label>
<label>form
<input id="form" type="checkbox" class="checkbox__button"></label>
<label>plank
